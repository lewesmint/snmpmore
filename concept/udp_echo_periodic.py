...
def main() -> None:
    ...
    # Validate arguments
    if args.send_port and not (args.target_ip or args.broadcast):
        parser.error("--send-port requires --target-ip or --broadcast")
    ...
    if args.send_port:
        ...
        sender_thread = threading.Thread(
            target=udp_sender,
            args=(args.send_port, args.target_ip, dest_port, args.period, args.message, stop_event, bool(args.broadcast), args.broadcast)
        )
        sender_thread.start()
